                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- forms -->
                            <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/TambahDataSppCon'); ?>" method="post">

                                <div class="form-group">
                                    <label for="jenisTransaksi">Nama</label>
                                    <input style="width: 500px; height: 40px;" type="text" class="form-control" id="inputJenisTransaksi" name="nama" placeholder="Cth: adi    " value="<?= set_value('nama'); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width: 500px; height: 40px;" type="date" class="form-control" id="tanggalbayar" name="tanggalbayar" placeholder="dd/mm/yyyy" value="<?= set_value('tanggalbayar'); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="dropdown show" style="width: 500px; height: 40px;">
                                        ...
                                        <select name="status" id="kategori" class="form-control" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:white; width:250px;">
                                            <option class="dropdown-item" href="#" disabled selected>-Pilih Status-</option>
                                            <option class="dropdown-item" href="#" value="Hutang" <?php if (set_value('status') == 'Hutang') {
                                                                                                        echo "selected";
                                                                                                    } ?>>Hutang</option>
                                            <option class="dropdown-item" href="#" value="Lunas" <?php if (set_value('status') == 'Lunas') {
                                                                                                        echo "selected";
                                                                                                    } ?>>Lunas</option>
                                        </select>
