                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- forms -->
                            <form style=" font-size:18px; color:black" action="<?= base_url('Welcome/UpdateDataAkunCon'); ?>" method="post" enctype='multipart/form-data'>
                                <input type="hidden" name="id" value="<?= $akun['id']; ?>">
                                <div class="form-group">
                                    <label for="tanggalKeu">Nama Siswa</label>
                                    <input style="width: 500px; height: 40px;" type="text" class="form-control" id="nama" name="nama" placeholder="Cth: Akun" value="<?= $akun['nama']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="tanggalKeu">NIK</label>
                                    <input style="width: 500px; height: 40px;" type="text" class="form-control" id="nik" name="nik" placeholder="Cth: Akun" value="<?= $akun['nik']; ?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="jenisTransaksi">Username</label>
                                    <input style="width: 500px; height: 40px;" type="text" class="form-control" id="username" name="username" placeholder="Cth: tes123" value="<?= $akun['username'] ?>" required>
                                </div>
