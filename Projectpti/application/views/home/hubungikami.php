...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>css/hubungikami.css">
</head>
...
<body>
    ...
    <body>
        ...
        <section class="header">
            <div class="headerisi">
                <h2 class="headerisii"> HUBUNGI KAMI</h2>
            </div>
            <section class="isi">
                <div class="isinya">
                    <div class="isinyakiri">
                        <h4> Datangi kami di : </h4>
                        <h4>gambar</h4>
                        <h4> JL. Bilal Ujung, Gang Surya No. 168 B, Kec. Medan Tembung,
                            Kota Medan, Sumatera Utara</h4>
                    </div>
                    <div class="isinyakanan">
                        <img src="<?= base_url() ?>img/aaa.png" alt="">
                        <div class="isinyakanansosmed">
